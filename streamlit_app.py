...
* __Ownership of Content:__ As between you and Luri, Inc., and to the extent permitted by applicable law, you (a) retain ownership rights in Input, and (b) own the Output. We hereby assign to you all our right, title, and interest, if any, in and to Output.
* __Similarity of Content:__ Due to the nature of our Services and artificial intelligence, Output may not be unique, and other users may receive similar Output. Our assignment of rights does not extend to Output generated by other users or any Third Party Output.
* __Our Use of Content:__ We may use Content to provide, maintain, develop, and improve our Services, comply with applicable laws, enforce our terms and policies, and ensure the safety and functionality of our Services.
* __Accuracy:__ Artificial intelligence and machine learning are evolving fields. We continuously work to improve our Services for accuracy, reliability, safety, and benefit. Due to the probabilistic nature of machine learning, Output may sometimes not accurately reflect real people, places, or facts.
...
* __Customer Responsibility for Subscription Costs:__ By subscribing to our service, you agree to pay all associated subscription costs as outlined at the time of purchase. It is your responsibility to ensure that your payment information is accurate and up-to-date.
* __Renewal and Billing:__ Subscriptions are billed on a recurring basis according to the plan you selected (e.g., monthly). Renewal charges will be automatically applied to your payment method on the renewal date of your subscription. It is your responsibility to review and understand the billing cycle of your subscription plan.
* __Cancellation and Non-Refund Policy:__ To avoid incurring additional charges, you must cancel your subscription before the next billing cycle begins. You can cancel your subscription through your account settings on our website. We do not provide refunds for any subscription charges that have already been processed.
* __Failure to Cancel:__ If you do not cancel your subscription prior to the renewal date, you will be billed for the upcoming billing cycle. You remain liable for all charges incurred as a result of continued subscription until you successfully cancel your subscription.
* __No Liability for Charges:__ We are not responsible for any costs or charges incurred due to failure to cancel your subscription in a timely manner. It is your sole responsibility to manage and cancel your subscription if you no longer wish to continue using our service.
...
if page == "Monthly Subscription":
    ...
    st.subheader("Follow us on Instagram and comment LURI.AI on any of our posts for an 80% off promo code for the first month of BriefCase!")
    st.wrote("Limited to the first 100 promo code redeemers. Redeemable until the end of August.")
